CLASS zcl_22ad070_sales_util DEFINITION 
  PUBLIC 
  FINAL 
  CREATE PRIVATE. 
  ...
  PUBLIC SECTION. 
    TYPES : BEGIN OF ty_sales_hdr, 
              salesdocument TYPE z22ad070_de_sorder, 
            END OF ty_sales_hdr, 
...
zcl_22ad070_sales_util. 
 
    METHODS : 
      set_hdr_value         IMPORTING im_sales_hdr TYPE z22ad070_vbak 
                            EXPORTING ex_created   TYPE abap_boolean, 
      get_hdr_value         EXPORTING ex_sales_hdr TYPE z22ad070_vbak, 
 
      set_itm_value         IMPORTING im_sales_itm TYPE z22ad070_vbap 
                            EXPORTING ex_created   TYPE abap_boolean, 
      get_itm_value         EXPORTING ex_sales_itm TYPE z22ad070_vbap, 
  ...
  PRIVATE SECTION. 
    CLASS-DATA : gs_sales_hdr_buff   TYPE z22ad070_vbak, 
                 gs_sales_itm_buff   TYPE z22ad070_vbap, 
                 gt_sales_hdr_t_buff TYPE tt_sales_hdr, 
                 gt_sales_itm_t_buff TYPE tt_sales_item, 
                 gv_so_delete        TYPE abap_boolean, 
                 mo_instance         TYPE REF TO zcl_22ad070_sales_util. 
ENDCLASS. 
 
CLASS zcl_22ad070_sales_util IMPLEMENTATION. 
